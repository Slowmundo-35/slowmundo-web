                    ...
                    <div key={idx} className="flex gap-6 relative">
                      ...
                      <div className="pb-4 w-full">
                        ...
                        <div className="flex flex-col md:flex-row gap-4">
                          ...
                          <div className="w-full md:w-32 h-24 bg-gray-200 rounded-lg overflow-hidden shrink-0 hidden md:block">
...
code = code.replace(/<div className="mb-12">\s*<h3 className="text-2xl font-bold mb-8 text-text-main">Aperçu de l'itinéraire<\/h3>[\s\S]*?<\/div>\s*<\/div>\s*\}\)/, newItinerarySection + '\n            )}');
